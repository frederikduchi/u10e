...
4. Info voor officials (scheidsrechters).
5. DWF Uitslag.
...
Ga naar het tabblad `DWF Uitslag` en klik op `DWF`. Dit brengt je naar volgend scherm (screenshots komen uit de testomgeving)
...
In het geval van een wissel tijdens een periode selecteer je eerst de speelster die er op komt (grijs), daarna de speelster die het veld verlaat (zwart).
...
> [!NOTE] Ter info
> Een speelster met 5 fouten over de ganse wedstrijd wordt uitgesloten voor de rest van de wedstrijd. Als een speelster al 3 fouten heeft in de eerste helft signaleer je dit best discreet aan de coach tijdens de rust.

**Wijzigen van periode**
Als een periode voorbij is start je een nieuwe periode door bovenaan het volgende cijfer tussen 1 en 8 aan te duiden
